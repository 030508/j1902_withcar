 ...
 */
@Controller
public class ArticleDraftsController {

    @Autowired
    private ArticleListService articleListService;
    @RequestMapping(value = "/valid/article-drafts",method = RequestMethod.GET)
    public String release(){
        return "article-drafts";
    }

    @RequestMapping(value = "/valid/articledrafts",method = RequestMethod.POST)
    @ResponseBody
